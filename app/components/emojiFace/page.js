...
//       <ul id="emoji" ref={emojiRef} className="relative w-[230px] h-[230px] transform translate-3d-0">
//         <li className="layer absolute w-full h-full" data-depth="0.2">
//           <div className="absolute inset-0 m-auto w-[230px] h-[230px] bg-[#feca32] rounded-full shadow-[inset_rgba(0,0,0,0.4)_0_0_30px]">
//           </div>
//         </li>
//         <li className="layer absolute w-full h-full" data-depth="0.3">
//           <div className="absolute inset-0 m-auto w-full h-full bg-gradient-to-b from-white via-transparent to-transparent rounded-full opacity-80">
//           </div>
//         </li>
//         <li className="layer absolute w-full h-full" data-depth="0.8">
//           <div className="absolute top-0 right-[70px] bottom-[40px] left-0 m-auto w-6 h-7 bg-[#a1620f] rounded-full shadow-[inset_rgba(0,0,0,0.5)_0_6px_12px,rgba(255,255,255,0.2)_0_2px_0_2px] animate-[blink_4s_infinite]">
//           </div>
//         </li>
//         <li className="layer absolute w-full h-full" data-depth="0.8">
//           <div className="absolute top-0 right-0 bottom-[40px] left-[70px] m-auto w-6 h-7 bg-[#a1620f] rounded-full shadow-[inset_rgba(0,0,0,0.5)_0_6px_12px,rgba(255,255,255,0.2)_0_2px_0_2px] animate-[blink_4s_infinite]">
//           </div>
//         </li>
//         <li className="layer absolute w-full h-full" data-depth="0.8">
//           <div className="mouth absolute top-[78px] right-0 bottom-0 left-0 m-auto overflow-hidden w-4 h-4
//            transform translate-3d-0 before:absolute before:inset-0 before:bottom-[10px] before:m-auto before:content-[''] before:w-full before:h-full before:bg-[#6e440b] before:rounded-full before:shadow-[rgba(255,255,255,0.25)_0_3px_0] before:scale-100 ">
//           </div>
//         </li>
//       </ul>
//     </div>
